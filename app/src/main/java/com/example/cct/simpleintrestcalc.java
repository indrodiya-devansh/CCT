...
public class simpleintrestcalc extends AppCompatActivity {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_simpleintrestcalc);
    }
    ...
    public void calculate(View view) {
        ...
        double time1 = Double.parseDouble(sell.getText().toString());
        calculationmethod check = new calculationmethod();
        String pro=check.simpleintrest(buy1,sell1,time1);
